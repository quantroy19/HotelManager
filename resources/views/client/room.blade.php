                                ...
                                <form class="price-range-slider" method="post" data-start-min="0"
                                    ...
                                    <div class="ui-range-slider-footer">
                                        <div class="ui-range-values">
                                            ...
                                            <div class="ui-range-value-min"><span class="min_price">gia min</span>
                                                <input type="hidden" value="100">
                                            </div> -
                                            <div class="ui-range-value-max"><span class="max_price">gia max</span>VND
                            ...
                            <div class="hotel-view bg-white radius-20">
                                ...
                                <div class="hotel-view-contents">
                                    <div class="hotel-view-contents-header">
                                        ...
                                        <h3 class="hotel-view-contents-title"> <a href="hotel_details.html"> King
                                                Suite Room </a> </h3>
                            ...
                            <div class="pagination-wrapper">
                                <ul class="pagination-list list-style-none">
                                    <li class="pagination-list-item-prev">
                                        <a href="javascript:void(0)" class="pagination-list-item-button"> Prev
                                        </a>
                                    </li>
                                    ...
                                    <li class="pagination-list-item-next">
                                        <a href="javascript:void(0)" class="pagination-list-item-button"> Next
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="hotel-view bg-white radius-20">
                                <div class="hotel-view-flex">
                                    <a href="hotel_details.html"
                                        ...
                                        style="background-image: url({{asset('bower_components/template-hotel-booking/beyond_hotel/assets/img/single-page/hotel-list1.jpg')}});">
                                    </a>
                                    <div class="hotel-view-contents">
                                        <div class="hotel-view-contents-header">
                                            <div
                                                ...
                                                <span class="hotel-view-contents-review"> <i
                                                        class="las la-star"></i> 4.5 <span
                                                        class="hotel-view-contents-review-count"> (380) </span>
                                                </span>
                                                <div class="btn-wrapper">
                                                    <a href="javascript:void(0)"
                                                        class="cmn-btn btn-bg-1 btn-small"> Reserve Now </a>
                                                </div>
                                            </div>
